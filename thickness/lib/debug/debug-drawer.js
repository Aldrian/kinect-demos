...
(function(){
    ...
    {   
        ...
        {   
            ...
            Ptypo.changeParam(parseFloat(Math.abs(skeleton.joints[7].position.x * 100 - skeleton.joints[11].position.x * 100 )), 'thickness', 'anrt-font');
            // draw body position
            ...
            for (var iJoint = 0; iJoint < skeleton.joints.length; ++iJoint) {
                ...
                if (joint.trackingState > 1){
                    ...
                    switch (joint.jointType) {
                      case 7:
                        drawJointAtXY(pos.x,pos.y, 30, '#ff00ff'); 
                        break;
                      case 11:
                        drawJointAtXY(pos.x,pos.y, 30, '#ff00ff'); 
                        break;
